...
trust-bazaar/               Iterated Prisoner's Dilemma
  programs/trust-bazaar/    Solana smart contract (Rust/Pinocchio)
    src/lib.rs              364 LOC BPF program
    tests/integration.rs    645 LOC Mollusk SVM tests
  audit/                    Security audit report
  deploy/                   Deployment log + program ID
